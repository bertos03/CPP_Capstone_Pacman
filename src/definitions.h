...
inline constexpr int WALL_VINE_SEGMENT_MIN_COUNT = 2;
inline constexpr int WALL_VINE_SEGMENT_MAX_COUNT = 5;
inline constexpr float WALL_VINE_THICKNESS_MIN_FACTOR = 0.009f;
inline constexpr float WALL_VINE_THICKNESS_MAX_FACTOR = 0.024f;
...
inline constexpr double WALL_VINE_LEAF_CHANCE = 0.30;
inline constexpr Uint8 WALL_VINE_BASE_ALPHA = 146;
inline constexpr SDL_Color WALL_VINE_DARK_COLOR{28, 62, 28, 255};
inline constexpr SDL_Color WALL_VINE_MID_COLOR{52, 110, 44, 255};
inline constexpr SDL_Color WALL_VINE_HIGHLIGHT_COLOR{124, 188, 96, 255};
