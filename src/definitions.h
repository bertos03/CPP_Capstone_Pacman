...
#define AIRSTRIKE_BOMB_COUNT 15
#define AIRSTRIKE_BOMB_INTERVAL_MS 85
#define AIRSTRIKE_BOMB_FALL_MS 260
#define AIRSTRIKE_PLANE_LEAD_IN_MS 760
#define AIRSTRIKE_PLANE_TRAIL_OUT_MS 760
