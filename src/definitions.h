...
inline constexpr Uint32 GOAT_LOVE_HEART_VISIBLE_MS = 1100;
inline constexpr Uint32 GOAT_MONSTER_DUST_LIFETIME_MS = 2800;
inline constexpr int GOAT_MONSTER_DUST_PUFF_COUNT = 36;
inline constexpr int LOVE_SMOKE_RANGE_CELLS = 3;
inline constexpr Uint32 LOVE_SMOKE_STEP_DURATION_MS = 90;
inline constexpr int LOVE_SMOKE_TRAIL_PUFF_COUNT = 7;
inline constexpr int LOVE_SMOKE_IMPACT_PUFF_COUNT = 28;
...
inline constexpr Uint8 LOVE_SMOKE_TRAIL_INITIAL_ALPHA = 110;
inline constexpr Uint8 LOVE_SMOKE_IMPACT_INITIAL_ALPHA = 51;
inline constexpr SDL_Color LOVE_SMOKE_COLOR{200, 50, 70, 255};
